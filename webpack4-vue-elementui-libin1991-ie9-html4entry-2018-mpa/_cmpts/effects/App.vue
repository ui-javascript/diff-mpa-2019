	...
	<div>
		...
		<div class="view">
			<loading-progress :progress="progress" :indeterminate="indeterminate" :counter-clockwise="counterClockwise"
				:hide-background="hideBackground" size="64" rotate fillDuration="2" rotationDuration="1" />

			<loading-progress :progress="progress" :indeterminate="indeterminate" :counter-clockwise="counterClockwise"
				:hide-background="hideBackground" shape="semicircle" size="64" />

			<loading-progress :progress="progress" :indeterminate="indeterminate" :counter-clockwise="counterClockwise"
				:hide-background="hideBackground" shape="line" size="200" width="200" height="6" />

			<loading-progress :progress="progress" :indeterminate="indeterminate" :counter-clockwise="counterClockwise"
				:hide-background="hideBackground" shape="square" size="64" fill-duration="2" />
			...
			<loading-progress :progress="progress" :indeterminate="indeterminate" :counter-clockwise="counterClockwise"
				:hide-background="hideBackground" shape="M50,3l12,36h38l-30,22l11,36l-31-21l-31,21l11-36l-30-22h38z"
				size="100" fill-duration="2" />
		</div>

		<div class="settings">
			<div>
				<input type="range" v-model="progressModel" min="-100" max="100" />
